...
r.noConflict=function(){return e.TraceKit=i,r},r.wrap=function(e){function n(){try{return e.apply(this,arguments)}catch(n){throw r.report(n),n}}return n},r.report=function(){function t(e){a(),p.push(e)}function i(e){for(var n=p.length-1;n>=0;--n)p[n]===e&&p.splice(n,1)}function c(e,t){var i=null
if(!t||r.collectWindowErrors){for(var c in p)if(n(p,c))try{p[c].apply(null,[e].concat(o.call(arguments,2)))}catch(l){i=l}if(i)throw i}}function l(e,n,t){var i=null
if(h)r.computeStackTrace.augmentStackTraceWithInitialElement(h,n,t,e),i=h,h=null,g=null
else{var o={url:n,line:t}
o.func=r.computeStackTrace.guessFunctionName(o.url,o.line),o.context=r.computeStackTrace.gatherContext(o.url,o.line),i={mode:"onerror",message:e,url:document.location.href,stack:[o],useragent:navigator.userAgent}}return c(i,"from window.onerror"),s?s.apply(this,arguments):!1}function a(){f!==!0&&(s=e.onerror,e.onerror=l,f=!0)}function u(n){var t=o.call(arguments,1)
if(h){if(g===n)return
var i=h
h=null,g=null,c.apply(null,[i,null].concat(t))}var l=r.computeStackTrace(n)
throw h=l,g=n,e.setTimeout(function(){g===n&&(h=null,g=null,c.apply(null,[l,null].concat(t)))},l.incomplete?2e3:0),n}var s,f,p=[],g=null,h=null
...
try{var i=t()
return i.open("GET",n,!1),i.send(""),i.responseText}catch(o){return""}}function o(e){if(!n(b,e)){var t="";-1!==e.indexOf(document.domain)&&(t=i(e)),b[e]=t?t.split("\n"):[]}return b[e]}function l(e,n){var r,i=/function ([^(]*)\(([^)]*)\)/,l=/['"]?([0-9A-Za-z$_]+)['"]?\s*[:=]\s*(function|eval|new Function)/,a="",u=10,s=o(e)
if(!s.length)return c
for(var f=0;u>f;++f)if(a=s[n-f]+a,!t(a)){if(r=l.exec(a))return r[1]
if(r=i.exec(a))return r[1]}return c}function a(e,n){var i=o(e)
if(!i.length)return null
var c=[],l=Math.floor(r.linesOfContext/2),a=l+r.linesOfContext%2,u=Math.max(0,n-l-1),s=Math.min(i.length,n+a-1)
n-=1
...
return t-=1,i&&i.length>t&&(r=c.exec(i[t]))?r.index:null}function g(n){for(var t,r,i,o,c=[e.location.href],l=document.getElementsByTagName("script"),a=""+n,p=/^function(?:\s+([\w$]+))?\s*\(([\w\s,]*)\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/,g=/^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/,h=0;h<l.length;++h){var d=l[h]
d.src&&c.push(d.src)}if(i=p.exec(a)){var m=i[1]?"\\s+"+i[1]:"",v=i[2].split(",").join("\\s*,\\s*")
t=u(i[3]).replace(/;$/,";?"),r=new RegExp("function"+m+"\\s*\\(\\s*"+v+"\\s*\\)\\s*{\\s*"+t+"\\s*}")}else r=new RegExp(u(a).replace(/\s+/g,"\\s+"))
if(o=f(r,c))return o
if(i=g.exec(a)){var x=i[1]
...
t={url:n[2],func:n[1]||c,line:+n[3],column:n[4]?+n[4]:null}}!t.func&&t.line&&(t.func=l(t.url,t.line)),t.line&&(t.context=a(t.url,t.line)),u.push(t)}return u[0]&&u[0].line&&!u[0].column&&s&&(u[0].column=p(s[1],u[0].url,u[0].line)),u.length?{mode:"stack",name:e.name,message:e.message,url:document.location.href,stack:u,useragent:navigator.userAgent}:null}function d(e){for(var n,t=e.stacktrace,r=/ line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\) in (.*):\s*$/i,i=t.split("\n"),o=[],c=0,u=i.length;u>c;c+=2)if(n=r.exec(i[c])){var s={line:+n[1],column:+n[2],func:n[3]||n[4],args:n[5]?n[5].split(","):[],url:n[6]}
if(!s.func&&s.line&&(s.func=l(s.url,s.line)),s.line)try{s.context=a(s.url,s.line)}catch(f){}s.context||(s.context=[i[c+1]]),o.push(s)}return o.length?{mode:"stacktrace",name:e.name,message:e.message,url:document.location.href,stack:o,useragent:navigator.userAgent}:null}function m(t){var r=t.message.split("\n")
...
p=f(C,[k]),w={url:k,line:p?p.line:S,func:""}}if(w){w.func||(w.func=l(w.url,w.line))
var R=a(w.url,w.line),O=R?R[Math.floor(R.length/2)]:null
...
if(i.url&&i.line){e.incomplete=!1,i.func||(i.func=l(i.url,i.line)),i.context||(i.context=a(i.url,i.line))
var o=/ '([^']+)' /.exec(r)
if(o&&(i.column=p(o[1],i.url,i.line)),e.stack.length>0&&e.stack[0].url===i.url){if(e.stack[0].line===i.line)return!1
if(!e.stack[0].line&&e.stack[0].func===i.func)return e.stack[0].line=i.line,e.stack[0].context=i.context,!1}return e.stack.unshift(i),e.partial=!0,!0}return e.incomplete=!0,!1}function x(e,n){for(var t,i,o,a=/function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i,u=[],s={},f=!1,h=x.caller;h&&!f;h=h.caller)if(h!==w&&h!==r.report){if(i={url:null,func:c,line:null,column:null},h.name?i.func=h.name:(t=a.exec(h.toString()))&&(i.func=t[1]),o=g(h)){i.url=o.url,i.line=o.line,i.func===c&&(i.func=l(i.url,i.line))
...
return w.augmentStackTraceWithInitialElement=v,w.guessFunctionName=l,w.gatherContext=a,w.ofCaller=y,w}(),r.remoteFetching||(r.remoteFetching=!0),r.collectWindowErrors||(r.collectWindowErrors=!0),(!r.linesOfContext||r.linesOfContext<1)&&(r.linesOfContext=7),e.TraceKit=r}(window),function(e,n){"use strict"
...
else try{document.fireEvent("on"+t.eventType.toLowerCase(),t)}catch(i){}}function r(e){for(var n=$.exec(e),t={},r=6;r--;)t[j[r]]=n[r]||""
return t}function i(e){return"undefined"==typeof e}function o(e){return"function"==typeof e}function c(e){return"string"==typeof e}function l(e,n){var t,r
if(i(e.length))for(t in e)e.hasOwnProperty(t)&&n.call(null,t,e[t])
else if(r=e.length)for(t=0;r>t;t++)n.call(null,t,e[t])}function a(){if(_)return _
var e=["sentry_version=4","sentry_client=raven-js/"+T.VERSION]
return b&&e.push("sentry_key="+b),_="?"+e.join("&")}function u(e,n){var r=[]
e.stack&&e.stack.length&&l(e.stack,function(e,n){var t=s(n)
...
return[[],n[t].substr(e.column,50),[]]}return[n.slice(0,t),n[t],n.slice(t+1)]}}function p(e,n,t,r,i,o){var c,l
n&&(R.ignoreErrors.test(n)||(i&&i.length?(c={frames:i},t=t||i[0].filename):t&&(c={frames:[{filename:t,lineno:r}]}),R.ignoreUrls&&R.ignoreUrls.test(t)||(!R.whitelistUrls||R.whitelistUrls.test(t))&&(l=r?n+" at "+r:n,d(g({exception:{type:e,value:n},stacktrace:c,culprit:t,message:l},o)))))}function g(e,n){return n?(l(n,function(n,t){e[n]=t}),e):e}function h(){var e={url:document.location.href,headers:{"User-Agent":navigator.userAgent}}
return document.referrer&&(e.headers.Referer=document.referrer),e}function d(e){v()&&(e=g({project:k,logger:R.logger,site:R.site,platform:"javascript",request:h()},e),e.tags=g(R.tags,e.tags),e.extra=g(R.extra,e.extra),e.tags||delete e.tags,e.extra||delete e.extra,E&&(e.user=E),o(R.dataCallback)&&(e=R.dataCallback(e)),(!o(R.shouldSendCallback)||R.shouldSendCallback(e))&&m(e))}function m(e){var n=new Image,r=y+a()+"&sentry_data="+encodeURIComponent(JSON.stringify(e))
...
w=e
try{O.report(e,n)}catch(t){if(e!==t)throw t}return T},captureMessage:function(e,n){return d(g({message:e},n)),T},setUser:function(e){return E=e,T},lastException:function(){return w}},j="source protocol user host port path".split(" "),$=/^(?:(\w+):)?\/\/(\w+)@([\w\.]+)(?::(\d+))?(\/.*)/
...
t.event.add=function(e,i,o,c,l){var a
return o.handler?(a=o.handler,o.handler=n.wrap(o.handler)):(a=o,o=n.wrap(o)),o.guid=a.guid?a.guid:a.guid=t.guid++,r.call(this,e,i,o,c,l)}
var i=t.fn.ready
...
try{return o.call(this,e,r)}catch(l){throw n.captureException(l),l}}}}(this,Raven,window.jQuery),function(e,n){"use strict"
...
;
window.LocalStore={version:4,keyPrefix:"ka",cacheKey:function(e){if(!e){throw"Attempting to use LocalStore without a key"}return[this.keyPrefix,this.version,e].join(":")},get:function(e){var o=window.localStorage[LocalStore.cacheKey(e)]
if(o){return JSON.parse(o)}return null},set:function(e,o){var t=JSON.stringify(o),a=LocalStore.cacheKey(e)
try{window.localStorage[a]=t}catch(r){LocalStore.clearAll()}},del:function(e){var o=this.cacheKey(e)
...
a["shared-package_badge"]=e(function(e,a,n,i,s){n=n||e.helpers
var t="",l,c,o,r,d=this,f="function",h=n.helperMissing,p=void 0,v=this.escapeExpression,g=n.blockHelperMissing
function m(e,a){return"achievement-badge-owned"}function b(e,a){var i="",s
i+="data-objectives='"
o=n.objectives
s=o||e.objectives
if(typeof s===f){s=s.call(e,{hash:{}})}else if(s===p){s=h.call(e,"objectives",{hash:{}})}i+=v(s)+"'"
return i}function u(e,a){var i="",s
i+='<div class="add-goal">'
o=n["_"]
s=o||e["_"]
r=d.program(6,y,a)
r.hash={}
r.fn=r
r.inverse=d.noop
if(o&&typeof s===f){s=s.call(e,r)}else{s=g.call(e,s,r)}if(s||s===0){i+=s}i+="</div>"
return i}function y(e,a){return"+ &emsp; Goal"}function x(e,a){var i="",s
i+='<div class="energy-points-badge">'
o=n.points
s=o||e.points
if(typeof s===f){s=s.call(e,{hash:{}})}else if(s===p){s=h.call(e,"points",{hash:{}})}i+=v(s)+"</div>"
return i}t+='<div class="achievement-badge category-'
o=n.badgeCategory
l=o||a.badgeCategory
if(typeof l===f){l=l.call(a,{hash:{}})}else if(l===p){l=h.call(a,"badgeCategory",{hash:{}})}t+=v(l)+" "
o=n.isOwned
l=o||a.isOwned
c=n["if"]
r=d.program(1,m,s)
...
r.inverse=d.noop
l=c.call(a,l,r)
if(l||l===0){t+=l}t+='" title="'
o=n.translatedSafeExtendedDescription
l=o||a.translatedSafeExtendedDescription
if(typeof l===f){l=l.call(a,{hash:{}})}else if(l===p){l=h.call(a,"translatedSafeExtendedDescription",{hash:{}})}t+=v(l)+'" '
o=n.canBecomeGoal
l=o||a.canBecomeGoal
c=n["if"]
r=d.program(3,b,s)
...
o=n.iconSrc
l=o||a.iconSrc
if(typeof l===f){l=l.call(a,{hash:{}})}else if(l===p){l=h.call(a,"iconSrc",{hash:{}})}t+=v(l)+'" id="badge-icon"/>\n  <div class="achievement-text">\n  <div class="achievement-title">'
o=n.translatedDescription
l=o||a.translatedDescription
if(typeof l===f){l=l.call(a,{hash:{}})}else if(l===p){l=h.call(a,"translatedDescription",{hash:{}})}t+=v(l)+'</div>\n  <div class="achievement-desc achievement-desc-no-count">\n    '
o=n.translatedSafeExtendedDescription
l=o||a.translatedSafeExtendedDescription
if(typeof l===f){l=l.call(a,{hash:{}})}else if(l===p){l=h.call(a,"translatedSafeExtendedDescription",{hash:{}})}t+=v(l)+"\n  </div>\n  </div>\n  "
o=n.canBecomeGoal
...
l["shared-package_topic-browser-pulldown"]=e(function(e,l,n,a,i){n=n||e.helpers
var r="",s,o,t,f,h=this,c="function",d=n.blockHelperMissing,u=n.helperMissing,p=void 0,v=this.escapeExpression
function m(e,l){return"Home"}function _(e,l){return"Knowledge Map"}function g(e,l){var a="",i
...
a+="\n        </div>\n    </div>\n  </li>\n  "
return a}function w(e,l){return"Goals"}function y(e,l){return"Goals"}function b(e,l){var a="",i,r
a+="\n    "
t=n.reordered_children
i=t||e.reordered_children
r=n["if"]
f=h.programWithDepth(k,l,e)
f.hash={}
f.fn=f
f.inverse=h.program(24,D,l)
i=r.call(e,i,f)
if(i||i===0){a+=i}a+="\n  "
return a}function k(e,l,a){var i="",r,s
i+='\n      <li class="level'
t=n.level
r=t||e.level
...
f.inverse=h.noop
r=s.call(e,r,f)
if(r||r===0){i+=r}t=n.translated_title
r=t||e.translated_title
if(typeof r===c){r=r.call(e,{hash:{}})}else if(r===p){r=u.call(e,"translated_title",{hash:{}})}i+=v(r)
t=n.href
r=t||e.href
...
f.inverse=h.noop
r=s.call(e,r,f)
if(r||r===0){i+=r}t=n.include_knowledgemap_link
...
s=n.each
f=h.programWithDepth(M,l,e)
f.hash={}
f.fn=f
f.inverse=h.noop
r=s.call(e,r,f)
if(r||r===0){i+=r}i+="\n          </ul>\n        </div>\n      </li>\n    "
return i}function B(e,l){var a="",i
a+='<a href="'
t=n.href
i=t||e.href
if(typeof i===c){i=i.call(e,{hash:{}})}else if(i===p){i=u.call(e,"href",{hash:{}})}a+=v(i)+'">'
return a}function H(e,l){return"</a>"}function x(e,l){var a="",i
...
return a}function G(e,l){return"Knowledge Map"}function M(e,l,a){var i="",r,s
i+='\n            <li class="level'
t=n.level
r=t||e.level
...
return i}function P(e,l){return" has-divider"}function T(e,l){var a="",i
a+='href="'
t=n.href
i=t||e.href
if(typeof i===c){i=i.call(e,{hash:{}})}else if(i===p){i=u.call(e,"href",{hash:{}})}a+=v(i)+'"'
return a}function D(e,l){var a="",i,r
a+='\n      <li class="level'
t=n.level
i=t||e.level
...
return a}function K(e,l){return" has-divider"}function W(e,l){var a="",i
a+='href="'
t=n.href
i=t||e.href
if(typeof i===c){i=i.call(e,{hash:{}})}else if(i===p){i=u.call(e,"href",{hash:{}})}a+=v(i)+'"'
return a}function E(e,l){return"Browse all"}r+="\n\n"
...
f.fn=f
f.inverse=h.noop
if(t&&typeof s===c){s=s.call(l,f)}else{s=d.call(l,s,f)}if(s||s===0){r+=s}r+='</a>\n  </li>\n  <li>\n    <a href="/exercisedashboard" class="menulink">'
t=n["_"]
s=t||l["_"]
f=h.program(3,_,i)
f.hash={}
...
window.onYouTubeIframeAPIReady=function(){if(!requireYouTubeAPI._scriptPromise){throw"Unencapsulated request for YouTube iframe API detected"}requireYouTubeAPI().resolve()}
...
t.find(".youtube-placeholder-title").hide()}})},atSeconds:function(e,t,i){this._poppler.add(e,t,i)},atPercent:function(e,t){if(e>=100){this.on("ended",t)
